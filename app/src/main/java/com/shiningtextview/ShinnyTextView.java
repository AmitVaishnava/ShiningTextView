...
/**
 * Created by avaishnava on 17/05/17.
 */
...
public class ShinnyTextView extends TextView {
        ...
        if (!isInEditMode()) {
            ...
            mAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(final ValueAnimator animation) {
                    ...
                    Shader shader = generateGradientShader(w*2, gradientStart, mGradientCenter, gradientEnd);
    ...
    private Shader generateGradientShader(int width, float... positions) {
        int[] colorRepartition = {Color.argb(255,98,185,255), Color.argb(255,245,245,245), Color.argb(255,98,185,255)};
